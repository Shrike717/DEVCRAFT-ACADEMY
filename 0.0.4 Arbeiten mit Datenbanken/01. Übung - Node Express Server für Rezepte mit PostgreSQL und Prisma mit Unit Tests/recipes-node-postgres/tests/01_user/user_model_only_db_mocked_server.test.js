...
// ******* ACHTUNG ********
// Diese Tests sind eine etwas seltsame Mischung aus gemockten Models, die aber teilweise auch das echte Modell mit testen. Nicht optimal.
...
jest.mock('@prisma/client', () => {
	const prisma = {
		user: {
			...
			// Hier müssen wir mockImplementation nehmen, da diese Funktion zwei Werte zurückgeben kann.
...
// Definieren Sie die Funktion mockGetUserById
const mockGetUserById = jest.fn();
// Definieren Sie die Funktion mockCreateUser
const mockCreateUser = jest.fn();
// Definieren Sie die Funktion mockUpdateUser
const mockUpdateUser = jest.fn();
// Definieren Sie die Funktion mockDeleteUser
